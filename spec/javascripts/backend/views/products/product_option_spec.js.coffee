describe "ProductOption View", ->
  beforeEach ->
    @productoptionview = App.Views.Products.ProductOption

  describe "Rendering", ->
    beforeEach ->
      @backboneView = new Backbone.View
      @backboneRenderSpy = sinon.spy(@backboneView, "render")
      @backboneViewStub = sinon.stub(window['App.Views.Products.ProductOption']).returns(@backboneView)
      ...
      @productoptionview.collection = new Backbone.Collection([
        @backboneModel1,
        @backboneModel2,
        @backboneModel3
      ])
      @productoptionview.render
