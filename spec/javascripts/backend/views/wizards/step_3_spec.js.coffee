describe "index View", ->
  beforeEach ->
    @step3view = App.Views.Wizards.Step3

  describe "Rendering", ->
    beforeEach ->
      @backboneView = new Backbone.View
      @backboneRenderSpy = sinon.spy(@backboneView, "render")
      @backboneViewStub = sinon.stub(window['App.Views.Wizards.Step3']).returns(@backboneView)
      ...
      @step3view.collection = new Backbone.Collection([
        @backboneModel1,
        @backboneModel2,
        @backboneModel3
      ])
