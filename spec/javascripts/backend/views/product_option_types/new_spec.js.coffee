describe "new View", ->
  beforeEach ->
    @newview = App.Views.ProductOptionTypes.New

  describe "Rendering", ->
    beforeEach ->
      @backboneView = new Backbone.View
      @backboneRenderSpy = sinon.spy(@backboneView, "render")
      @backboneViewStub = sinon.stub(window['App.Views.ProductOptionTypes.New']).returns(@backboneView)
      ...
      @newview.collection = new Backbone.Collection([
        @backboneModel1,
        @backboneModel2,
        @backboneModel3
      ])
