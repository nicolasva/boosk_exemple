describe "Show View", ->
  beforeEach ->
    App.Views.Shops.Show.prototype.template = JST["app/assets/javascripts/facebook/templates/shop/show"]
    App.Views.Shops.Show.prototype.template_show_next = JST["app/assets/javascripts/facebook/templates/infinity/show_next"]
  ...
  describe 'instantiation', ->
    ...
    it "binds on '.product_lists' element", ->
      #console.log @shop1
      expect(@showview.$el.selector).toEqual(".product_lists")
